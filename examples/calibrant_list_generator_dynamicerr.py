...
def assign_formula(file, time_min, time_max, interval, data_dir, error):
    ...
    MSParameters.mass_spectrum.min_ppm_error = error-0.5 # minimum ppm error for detecting m/z calibrant peaks
    MSParameters.mass_spectrum.max_ppm_error = error+0.5 # maximum ppm error for detecting m/z calibrant peaks
    ####
...
if __name__ == '__main__':
    ...
    for index, row in samplelist.iterrows():
        ...
        args = (time_min,time_max,interval,data_dir,file,refmasslist,error)
